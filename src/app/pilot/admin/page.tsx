                  ...
                  <div className="rounded-2xl bg-white text-slate-900 overflow-hidden border border-slate-200 shadow-md">
                    ...
                    <div className="p-4 space-y-3 text-xs">
                      ...
                      <div className="py-1 text-center">
                        <a
                          href={`https://www.flowloopos.com/pilot?utm_source=cold_outbound&company=${encodeURIComponent(selectedProspect.companyName)}&utm_campaign=${selectedProspect.state.toLowerCase()}_pilot`}
                          target="_blank"
                      ...
                      <div className="text-[10px] text-slate-500 pt-2 border-t border-slate-200">
                        <strong>Sign-off:</strong> FlowLoop OS Team • <a href="mailto:onboarding@flowloopos.com" className="text-sky-600 font-mono">onboarding@flowloopos.com</a> • <a href={`https://www.flowloopos.com/pilot`} target="_blank" className="text-sky-600 font-mono">flowloopos.com/pilot</a>
                      </div>
                    </div>
                  </div>
                </div>
